...
def prepare_data_seq(f_tr, f_te,batch_size=8,shuffle=True):
    file_train = f_tr
    ...
    pair_test,max_len, max_r = read_langs(file_test,max_line=None)    
    
    test = get_seq(pair_test,lang,batch_size,True,max_len)    
    ...
    return train,test,lang, max_len, max_r
