...
#    file_train = 'data/100_clusters2/all_train/cluster{}.txt'.format(task)
 #   file_dev = 'data/100_clusters2/all_test/cluster{}.txt'.format(task)
  #  file_test = 'data/100_clusters2/all_test/cluster{}.txt'.format(task)
    
    file_train = 'data/webnlg2/all_train/cluster{}.txt'.format(task)
    file_dev = 'data/webnlg2/all_test/cluster{}.txt'.format(task)
    file_test = 'data/webnlg2/all_test/cluster{}.txt'.format(task)    
